...
client.on('message', message => {
    ...
    if (msg.content === 'الوان') {
      if (msg.channel.id !== "478826880921763840") return;
      msg.channel.send({file : "https://cdn.discordapp.com/attachments/478826880921763840/487907746348531712/p_979czndu1.png"})
    }
  });
client.on('message', message => {
    let args = message.content.split(' ').slice(1);
if(message.content.split(' ')[0] == 'لون'){
if (message.channel.id !== "478826880921763840") return;
