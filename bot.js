...
if (message.content === '-help') {
	var embed  = new Discord.RichEmbed()
	                    .addField(الاوامر العامه )
         .addField⤠(" ** -avatar ** **لكي يعطيك رابط صورتك او صورة صديقك** ")
         .addField⤠(" ** -server ** **لمعلومات السيرفر** ")
         .addField⤠(" ** -id ** **لمعلومات عنك** ")
         .addField⤠(" ** -ping ** **للتحقق من سرعة الاتصال** ")
         .addField⤠(" ** -invite ** **للمعرفة انت كم جايب عضو ل السيرفر** ")
         .addField⤠(" ** -link ** **للتحقق من سرعة الاتصال** ")
         .addField⤠(" ** -music ** **اوامر لتشغيل الاغاني** ")
         .addField⤠(" ** -quran ** **لتشغيل القرآن الکریم** ")
         .addField⤠(" ** -admin ** **الاوامر الادارية** ")
         .addField⤠(" ** -player ** **لمعرفة عدد اعضاء السيرفر** ")
                .setColor('RANDOM')
.setColor('RANDOM')
